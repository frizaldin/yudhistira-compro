                ...
                <div class="card-body">
                    <form id="basic-form" action="{{ $base_url . '/update' }}" class="_form" method="post"
                        ...
                        <div class="form-group">
                            ...
                            @if($item->logo)
                                <img style="width: 100px; margin-top: 10px;" src="{{ asset($item->logo) }}" />
                            @endif
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="url" id="url" class="form-control" readonly value="{{ $item->url ?? '' }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="deskripsi" id="deskripsi"
                                class="form-control summernote">{{ $item->deskripsi ?? '' }}</textarea>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="iframe_youtube" id="iframe_youtube" class="form-control" rows="3"
                                placeholder="Paste iframe YouTube code here">{{ $item->iframe_youtube ?? '' }}</textarea>
                        </div>
