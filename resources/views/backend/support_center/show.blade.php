<x-backend.layouts>
    <div class="container-fluid">
        ...
        <div class="page-title-box d-flex align-items-center mb-0">
            <a href="{{ url('backend/support-centers') }}" class="btn btn-link text-dark p-0 me-3"
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <form action="{{ url('backend/support-centers/' . $item->id . '/status') }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="row g-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="note" class="form-control" placeholder="Contoh: Support Center #{{ $item->ticket_number }} (selesai)" value="{{ old('note') }}">
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                                ...
                                <div class="rounded p-3 {{ $chat->viewpoint === 'admin' ? 'bg-primary text-white' : 'bg-light' }} position-relative"
                                        ...
                                        <div class="position-absolute top-0 end-0 pe-2 pt-1">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <li>
                                                        <form
                                                            action="{{ url('backend/support-centers/chats/' . $chat->id) }}"
                                    ...
                                    @if ($chat->viewpoint === 'admin')
                                        <div class="chat-edit-form-{{ $chat->id }} d-none mt-2">
                                            <form action="{{ url('backend/support-centers/chats/' . $chat->id) }}"
                        ...
                        <hr class="my-4">
                        <form action="{{ url('backend/support-centers/' . $item->id . '/chat') }}" method="post"
