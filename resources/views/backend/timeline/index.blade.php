    ...
    <div class="container-fluid">
        <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                <div class="me-3">
                    <a href="{{ url('backend/timeline/add') }}" class="btn btn-primary"><i class="fa fa-plus mr-1"></i>
                        Tambah Data</a>
                </div>
                <div class="">
                                ...
                                <tbody>
                                    @foreach ($collection as $item)
                                        <tr id="data-{{ $item->id }}">
                                            ...
                                            <td>
                                                <p>{{ \Illuminate\Support\Str::limit($item->description ?? $item->deskripsi, 50) }}</p>
                                            </td>
                                            <td>
                                                <span
                                            ...
                                            <td style="width: 10%;">
                                                <a href="{{ url('backend/timeline/edit/' . $item->id) }}"
                                                    class="btn btn-sm btn-info" title="Edit"><i
                                                        class="fa fa-edit"></i></a>
                                                <form action="{{ url('backend/timeline/delete') }}"
