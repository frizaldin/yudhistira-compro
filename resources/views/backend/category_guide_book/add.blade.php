<x-backend.layouts>
    ...
    <div class="row clearfix">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header"><h2>Tambah {{ $title }}</h2></div>
                <div class="card-body">
                    <form id="basic-form" action="{{ $base_url . '/store' }}" class="_form" method="post">
                        ...
                        <div class="form-group">
                            <label>URL (opsional, kosongkan untuk auto dari title)</label>
                            <input type="text" name="url" class="form-control" placeholder="slug-url">
                        </div>
                        <div class="form-group">
                            <label>Urutan</label>
