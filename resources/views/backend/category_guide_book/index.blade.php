    ...
    <div class="container-fluid">
        <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
            ...
            <div class="d-flex align-items-center">
                <div class="me-3">
                    <a href="{{ $base_url . '/add' }}" class="btn btn-primary"><i class="fa fa-plus mr-1"></i> Tambah Data</a>
                </div>
                <div class="">
                                ...
                                <tbody>
                                    @foreach ($collection as $item)
                                        <tr id="data-{{ $item->id }}">
                                            ...
                                            <td>{{ $item->url ?? '-' }}</td>
                                            <td>
                                                <span class="badge {{ $item->visible == 'yes' ? 'bg-success' : 'bg-danger' }}">{{ $item->visible == 'yes' ? 'Ya' : 'Tidak' }}</span>
                                            </td>
                                            <td>{{ $item->order }}</td>
                                            <td style="width: 10%;">
