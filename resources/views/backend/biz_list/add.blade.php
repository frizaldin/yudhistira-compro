                ...
                <div class="card-body">
                    <form id="basic-form" action="{{ $base_url . '/store' }}" class="_form" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description_1" id="description_1" class="form-control summernote"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Photo 1</label>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description_2" id="description_2" class="form-control summernote"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Photo</label>
                        ...
                        <div class="form-group">
                            <label for="description">Deskripsi</label>
                            <textarea name="description_3" id="description_3" class="form-control summernote"></textarea>
                        </div>
                        <div class="form-group">
                            <label>Photo</label>
