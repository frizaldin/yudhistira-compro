            ...
            <div class="tab-content padding-0">
                ...
                <div class="tab-pane active" id="Overview">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form id="basic-form" action="{{ url('backend/configuration/profile-more/update') }}"
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email_marketing" name="email_marketing" class="form-control" required
                                        value="{{ $item->email_marketing }}">
                                </div>
                                <div class="form-group">
                                    <label>No Telepon</label>
                                    <input type="telp_marketing" name="telp_marketing" class="form-control" required
                                        value="{{ $item->telp_marketing }}">
                                </div>
                                <div class="form-group">
                                    <label>Website</label>
                                    <input type="website" name="website" class="form-control" required
                                        value="{{ $item->website }}">
                                </div>
                                <div class="form-group">
