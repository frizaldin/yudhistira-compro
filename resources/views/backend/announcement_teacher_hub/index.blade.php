<x-backend.layouts>
    <div class="container-fluid">
        <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
            <h4 class="page-title">Pengumuman Guru</h4>
            <div class="d-flex align-items-center">
                <div class="me-3">
                    <a href="{{ url('backend/announcement-teacher-hubs/add') }}" class="btn btn-primary"><i class="fa fa-plus mr-1"></i>
                        Tambah Data</a>
                </div>
                <div class="">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active">Pengumuman Guru</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    @foreach ($collection as $item)
                                        <tr id="data-{{ $item->id }}">
                                            ...
                                            <td style="width: 10%;">
                                                <a href="{{ url('backend/announcement-teacher-hubs/edit/' . $item->id) }}"
                                                    class="btn btn-sm btn-info" title="Edit"><i class="fa fa-edit"></i></a>
                                                <form action="{{ url('backend/announcement-teacher-hubs/delete') }}"
