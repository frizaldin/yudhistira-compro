<x-backend.layouts>
    <div class="container-fluid">
        <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
            <h4 class="page-title">Tambah Pengumuman Guru</h4>
            <div class="">
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h2>Tambah Pengumuman Guru</h2>
                </div>
                <div class="card-body">
                    <form id="basic-form" action="{{ url('backend/announcement-teacher-hubs/store') }}" class="_form"
