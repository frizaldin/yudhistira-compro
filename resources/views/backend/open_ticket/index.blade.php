<x-backend.layouts>
    <div class="container-fluid">
        <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
            <h4 class="page-title">Open Ticket</h4>
        ...
        <div class="row clearfix">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <form method="get" action="{{ url('backend/open-tickets') }}" class="mb-3 row g-2">
                            <div class="col-auto">
                                ...
                                <tbody>
                                    @forelse ($collection as $item)
                                        <tr id="data-{{ $item->id }}">
                                            ...
                                            <td>
                                                <a href="{{ url('backend/open-tickets/' . $item->id) }}" class="btn btn-sm btn-info" title="Lihat"><i class="fa fa-eye"></i> Lihat</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
