...
<div class="error">
    <div class="error__title">501</div>
    <div class="error__subtitle">Comming Soon...</div>
    <div class="error__description">
        Fitur akan segera datang
    </div>
    <a href="{{ url()->previous() }}" class="error__button error__button--active">Kembali</a>
